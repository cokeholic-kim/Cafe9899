...
import { checkPassword } from './Join';
    ...
    return (
        <UpdatePassStyle>
            ...
            <form onSubmit={onSubmit}>
                <label >비밀번호</label>
                <div>
                    <input ref={pass} value={formData.m_pass} name="m_pass" minLength="8" maxLength="20" onChange={onChange} type="password"placeholder="영문 대,소문자 + 숫자 + 특수문자를 포함하여 10~20자" />
                </div>
                <label>비밀번호 재확인</label>
                <div>
                    <input ref={passch} value={formData.m_passch} name="m_passch" minLength="8" maxLength="20" onChange={onChange} type="password"placeholder="" />
                </div>
                <span ref={passcheck}></span>
            <div>
